...
#            self.visualize_pointcloud(points, subsample_factor)
#            self.visualize_pointcloud(points_subsampled)
            ...
            print(f"Mesh created with {mesh.n_cells} cells")
