...
class DEM:
    def __init__(self, config)    -> None:
        """
        Converting Digital Elevation Models (DEM) into 3D mesh models.
            - param config: dict     configuration dictionary containing path to DEM
                                     the configuration file / dictionary is updated with:
                                        - 'AUTOGENERATED': 'dem_epsg'          - the EPSG code of the DEM
                                        - ELEVATION MODELS: 'model_path'       - the path to the generated 3D mesh model
                                        - ELEVATION MODELS: 'subsample_factor' - the factor by which the point cloud is subsampled
            - return: -
        """
    ...
    PRIVATE METHODS
    """
    def _dem_2_mesh(self, config) -> None:
        """
